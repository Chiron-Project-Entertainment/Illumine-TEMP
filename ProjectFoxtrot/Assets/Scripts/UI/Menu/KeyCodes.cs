...
/// <summary> Every main KeyCode, organised by key types. </summary>
public static class KeyCodes
{
    /// <summary> Array containing all the mouse button keycodes. </summary>
    ...
    /// <summary> Array containing all the letter key keycodes. </summary>
    ...
    /// <summary> Array containing all the number key keycodes. </summary>
    ...
    /// <summary> Array containing all the arrow key keycodes. </summary>
    ...
    /// <summary> Array containing all the modifier key keycodes. </summary>
    ...
    /// <summary> Array containing all the function key keycodes. </summary>
    ...
    /// <summary> Array containing all the symbol key keycodes. </summary>
    ...
    /// <summary> Array containing all the existing keycodes. </summary>
