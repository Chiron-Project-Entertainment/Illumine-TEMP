...
public class SettingsMenu : MonoBehaviour
{
    ...
    #region Controls settings variables
    [Header("Controls settings")]
    [SerializeField] private Toggle autoSprintToggle = null;
    #endregion
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < Screen.resolutions.Length; i++)
        {
            ...
            Vector3 tempResValues = new Vector3(Screen.resolutions[i].width, Screen.resolutions[i].height, Screen.resolutions[i].refreshRate);
            Vector3 maxResValues = new Vector3(Screen.width, Screen.height, Screen.currentResolution.refreshRate);

            if (tempResValues == maxResValues) maxScreenRes = i;
        }
    ...
    public void SetAutoSprint(bool isEnabled) { Controls.instance.AutoSprinting = isEnabled; }
